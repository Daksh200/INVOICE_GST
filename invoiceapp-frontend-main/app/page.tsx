    ...
    <div className="min-h-screen bg-background">
      ...
      <footer className="border-t bg-muted/30">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center text-sm text-muted-foreground">© 2026 InvoiceGST. All rights reserved.
          </div>
          <div className="mt-4 text-center text-sm text-foreground">
            Crafted with ❤️ by <span className="text-primary hover:underline">
              <Link href="https://portfollio-one-cyan.vercel.app/" target="_blank" rel="noopener noreferrer">
                Daksh
              </Link>
            </span>
          </div>
